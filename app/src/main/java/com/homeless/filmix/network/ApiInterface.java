package com.homeless.filmix.network;

import com.homeless.filmix.network.movies.Movie;
import com.homeless.filmix.network.movies.MovieCastsOfPersonResponse;
import com.homeless.filmix.network.movies.MovieCreditsResponse;
import com.homeless.filmix.network.movies.NowShowingMoviesResponse;
import com.homeless.filmix.network.movies.PopularMoviesResponse;
import com.homeless.filmix.network.movies.SimilarMoviesResponse;
import com.homeless.filmix.network.movies.TopRatedMoviesResponse;
import com.homeless.filmix.network.movies.UpcomingMoviesResponse;
import com.homeless.filmix.network.people.Person;
import com.homeless.filmix.network.tvshows.AiringTodayTVShowsResponse;
import com.homeless.filmix.network.tvshows.OnTheAirTVShowsResponse;
import com.homeless.filmix.network.tvshows.PopularTVShowsResponse;
import com.homeless.filmix.network.tvshows.SimilarTVShowsResponse;
import com.homeless.filmix.network.tvshows.TVCastsOfPersonResponse;
import com.homeless.filmix.network.tvshows.TVShow;
import com.homeless.filmix.network.tvshows.TVShowCreditsResponse;
import com.homeless.filmix.network.tvshows.TopRatedTVShowsResponse;
import com.homeless.filmix.network.videos.VideosResponse;
...
public interface ApiInterface {
    ...
    Call<com.homeless.filmix.network.movies.GenresList> getMovieGenresList(@Query("api_key") String apiKey);
    ...
    @GET("genre/tv/list")
    Call<com.homeless.filmix.network.tvshows.GenresList> getTVShowGenresList(@Query("api_key") String apiKey);
